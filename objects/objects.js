// Of the eight data types in JS, seven are primitive because their values
// contain a single thing. Objects are used to store keyed collections of
// various data and more complex entities.
//
// Objects are used a lot in JS, so we must understand them first before going
...
// Adding square brackets to an object literal property is known as a computed
// property.
...
// Accessing a property that doesn't exist won't give an error, it will return
// undefined.
...
// Use a quoted string for the target property since a variable would use it's
// value
let b = false;
console.log(b in x);
